...
import de.dengot.copylineeditor.logic.exception.ParserException;
...
import de.dengot.copylineeditor.logic.scanner.token.ValueToken;
import de.dengot.copylineeditor.model.Field;
import de.dengot.copylineeditor.model.FieldType;
import de.dengot.copylineeditor.model.FieldTypeFactory;
import de.dengot.copylineeditor.model.FieldValueRange;
import de.dengot.copylineeditor.model.NumericFieldType;
import de.dengot.copylineeditor.model.SimpleFieldValue;
...
public class CopylineParser
{
    ...
    public Field parse(int rootStepNumber, String copylineName, ParserTokenStream toBeParsed) throws StructureException
    {
    	//init TokenStream
        ...
        Field root = new Field(rootStepNumber, copylineName);
    ...
    private void parseField() throws StructureException
    {
        ...
        field.setOffset(this.currentOffset);
    ...
    private int parseStepNumber() throws ParserException
    {
        if (currentToken().isCardinalToken())
        {
            ...
            //remember offset as start of field definition
            this.currentOffset = currentToken().getPosition();
            skipToken();
            return stepNumber;
        }
        else
